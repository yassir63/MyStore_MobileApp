...
export class ProduitsAchetesController {
  ...
  @Patch('/:idA/:idP')
  update(@Param('idA') idA: number , @Param('idP') idP: number, @Body() updateProduitsAcheteDto: UpdateProduitsAcheteDto) {
    return this.produitsAchetesService.update(+idA , +idP, updateProduitsAcheteDto);
  }
